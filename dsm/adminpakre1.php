...
session_start();
 ...
 $id=$_GET["id"];
 $result=mysqli_query($link,"select * from payinfo where payid=$id ");
 $result1=mysqli_query($link,"select * from reg where usertype='trainer' ");
  ...
  <tbody>
    <tr>
      <td>
		  ...
		  <form method="post" action="adminpakre2.php" name="reg">
...
<option value="" selected disabled>Select</option>
 ...
 $_SESSION['pn']=$row['package'];
 $_SESSION['u']=$row['payid'];
