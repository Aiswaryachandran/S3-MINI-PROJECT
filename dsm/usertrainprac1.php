            ...
            <tr>
              ...
              <td width="80%" rowspan="7" align="left" valign="top"><!-- InstanceBeginEditable name="EditRegion1" -->
                <table width="100%" border="0" cellpadding="0">
				  ...
				  $a2=$_POST["t2"];
				  $a3=$_POST["t3"];
				   $result4=mysqli_query($link,"select dprid from dpr order by dprid DESC ");
				  ...
				  mysqli_query($link,"insert into dpr values($dprid,$id,'$a1','$da','$a2','$a3',NULL,0)");
				  ?>
				
				<h1> <center> Successfully Updated</center></h1>
				<center><a href="userHome.php">Goto Home</a></center>
						</td>
                    </tr>
                  </tbody>
                </table>
