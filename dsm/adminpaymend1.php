...
<table width="100%" border="0" cellpadding="0">
  ...
  <tbody>
	  ...
	  <table align="center">
		  <form action="adminpaymend2.php" method="post" name="f">
  <tbody>
    <tr>
...
<option value="" selected disabled>Description</option>
  <option value="Paid">Paid</option>
	  ...
	  <tr>
		  <td><input type="text" name="t2" id="t2" placeholder="Details"> </td>
		  <td></td>
	  </tr>
    
      <td colspan="2" align="center">
		  <input  type="button" onClick="FEEDBACK()" value="pay"> </td>
      <td></td>
    </tr>
  </tbody>
</table>
