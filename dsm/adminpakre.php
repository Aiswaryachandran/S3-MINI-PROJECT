...
<table width="100%" border="0" cellpadding="0">
 ...
 ?>
  ...
  <tbody>
    <tr>
      <td>
		 <center><h1> Package Request</h1></center>
...
if(isset($_SESSION['m1']))
  ...
  <tbody>
    <tr align="center" valign="bottom" bgcolor="#E91D20">
      <td>ID</td>
      <td>Name</td>
    </tr>
    <?php
...
?>
<tr align="center" valign="bottom" bgcolor="#FB9E9E">
    <td><?php echo $row['pid']?></td>
<td><a href="adminpakre1.php?id=<?php echo $row['payid']?>">
