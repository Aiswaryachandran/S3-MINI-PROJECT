...
$result = mysqli_query($link,"SELECT b.*,a.username FROM reg a,dpr b where a.id=b.userid");
    ?>
    ...
    <br>
		  <center><h2>Driving Practice Request</h2></center>
        <table align="center" width="50%" border="1">
            ...
            <tr bgcolor="#FB9E9E">
            <td align="center">
            <?php echo $row['dprid']?></td>
            <td align="center"><a href="admindpr1.php?eid=<?php echo $row['dprid']?>">
