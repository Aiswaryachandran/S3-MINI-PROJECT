    ...
    <tr>
      <td>
		  ...
		  session_start();
				  ...
				  $a6=$_POST["t6"];
				  $a7=$_POST["t7"];
                   $result=mysqli_query($link,"select pid from package order by pid DESC ");
				  ...
				  else
				  {
                   ...
                   mysqli_query($link,"insert into package values($id,'$a1','$a2','$a3','$a4','$a5','$a6','$a7',0)");
					 
				  }
					  ?>
					 <center> <h1> Successfully Uploaded</h1> <center>
