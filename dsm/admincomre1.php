...
<table width="100%" border="0" cellpadding="0">
 ...
 $result=mysqli_query($link,"select * from comm where cid=$id ");
...
<script language="javascript">
  ...
  <tbody>
    <tr>
      <td>
		  <form method="post" action="admincomre2.php" name="reg">
  ...
  <tr align="center" valign="middle">
    <td colspan="2"><input type="button" value="sent" onClick=" validation()"></td>
    <td></td>
  </tr>
</table>
</form>
