...
<table width="100%" border="0" cellpadding="0">
  ...
  <tbody>
	  ...
	  {
		  $result=mysqli_query($link,"select * from login where usertype='user'");
  ...
  <tbody>
    <tr align="center" valign="middle" bgcolor="#E91D20" >
      <td><h3 ><em><strong>ID</strong></em></h1></td>
      <td><h3><em><strong>NAME</strong></em></h3></td>
    </tr>
	  <?php
    ...
    <tr  align="center" valign="middle" bgcolor="#FB9E9E">
      <td><em><strong>
		...
		<td><a href="adminuserview1.php?id=<?php echo $row['id']?>"><?php echo $row['username']?></a>
		  </td>
    </tr>
	  <?php
			  }		  }
