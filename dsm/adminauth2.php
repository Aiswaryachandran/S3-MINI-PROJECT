...
<table width="100%" border="0" cellpadding="0">
  ...
  <tbody>
    ...
    <tr align="left" bgcolor="#FB9E9E">
      ...
      <td valign="top"><div class="contatct-table">
  <p>
   <a href="reject.php?id=<?php echo $row['id']?>"> <input type="button" value="Reject" id="s2" ></a>
	 	    	</div></td>
      <td valign="top"><div class="contatct-table">
  <p>
    <a href="accept.php?id=<?php echo $row['id']?>"><input type="button" value="Accept" id="s2"></a>
	 	    	</div></td>
    </tr>
  </tbody>
</table>
