    ...
    <tr>
      <td>
		...
		<?php
				  ...
				  $result1=mysqli_query($link,"select * from comm where recid=$id");
			//$row1=mysqli_fetch_array($result1);
				  ?>
				<table  width="100%" border="0" cellpadding="0" frame="border">
				  <tbody>
				    <tr>
				      <td colspan="4" align="center" bgcolor="#F50C0C">INBOX</td>
				      </tr>
				  ...
				  ?>
				    <tr bgcolor="#FB9E9E">
				      ...
				      <td><?php echo $row1['date'] ?></td>
						<td><a href="trainermessage1.php?id=<?php echo $row1['cid']?>">View</a></td>
						  <?php }
		  }?>
				      </tr>
				    <tr>
