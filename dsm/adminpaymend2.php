    ...
    <tr>
      <td>
		...
		session_start();
		  ...
		  $a2=$_POST['t2'];
		  $a3=date('d-M-y');
		 // echo "UPDATE payinfo SET status=1,dscription='$a1',purpose='$a2',dateofpayment='$a3' WHERE payid=$id";
			  
		  mysqli_query($link,"UPDATE payinfo SET status=1,dscription='$a1',purpose='$a2',dateofpayment='$a3' WHERE payid=$id");
