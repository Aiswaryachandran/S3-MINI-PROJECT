          ...
          <tbody>
			...
			$row=mysqli_fetch_array($result);
				  $username=$row['username'];
				   ...
				   $result1=mysqli_query($link,"select * from package where pid=$pid");
			$row1=mysqli_fetch_array($result1);
				  $amount=$row1['amount'];
				  $package=$row1['typeofpack'];
				 
				  $result2=mysqli_query($link,"select payid from payinfo order by payid DESC ");
				  ...
				  else
				  {
				   ...
				   mysqli_query($link,"insert into payinfo values($payid,$id,NULL,NULL,$amount,'not paid',NULL,0,0,$pid,'$username','$package')");
				  
				  
				   mysqli_query($link,"update login set status=2 where id=$id");
				  ?>
				
					<div class="m_contact"><span class="left_line1"> </span>Sucessfully Booked<span class="right_line1"> </span></div>	
				  <br>
				  <br>
				  <center>
				  ...
				  <h1>
				  Download receipt from <a href="userpayment.php">QUICK PAY</a> for your package confirmatiom......
				  </center></h1></td>
                    </tr>
                  </tbody>
                </table>
