...
$date=date("d-m-y h:i:sa");
		  ...
		  mysqli_query($link,"UPDATE comm SET status=1 WHERE cid=$cid");
mysqli_query($link,"UPDATE comm SET adminupdate='$m1',updatedate='$date' WHERE cid=$cid");
		  ...
		  ?>
			  ...
			  <br>
			  <center>
			  <a href="userinbox.php">Go To Inbox.... </a>
			  </center>
				</td>
                    </tr>
                  </tbody>
