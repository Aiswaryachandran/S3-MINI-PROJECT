            ...
            <tr>
              ...
              <td width="80%" rowspan="7" align="left" valign="top"><!-- InstanceBeginEditable name="EditRegion1" -->
                <table width="100%" border="0" cellpadding="0">
				  ...
				  $a1=$_POST["t1"];
				  $a2=$_POST["t2"];
				   $result4=mysqli_query($link,"select eid from enquiry order by eid DESC ");
				  ...
				  mysqli_query($link,"insert into enquiry values($eid,$id,'$da','$a1','$a2',NULL,0)");
				  ?>
				
				<h1> <center> Successfully Updated</center></h1>
				<center><a href="userHome.php">Goto Home</a></center></td>
                    </tr>
                  </tbody>
                </table>
