...
<table width="100%" border="0" cellpadding="0">
    ...
    <tr>
      <td height="600" align="left" valign="top"><table width="100%">
		...
		<?php
		  ...
		  $result1=mysqli_query($link,"select * from comm where userid=$id");
		 
		
		  ?>
						  
						  <h2><center>Admin Reply</center></h2>
  ...
  <tbody>
    <tr bgcolor="#F50C0C">
      ...
      <td><font color="#FFFFFF">Admin Update</font></td>
      <td><font color="#FFFFFF">Update date</font></td>
    </tr>
	  <?php
...
if($row1['status']==1)
    ...
    <tr bgcolor="#FB9E9E">
     ...
     <td valign="top"><?php echo $row1['message']?></td>
      ...
      <td valign="top"><?php echo $row1['updatedate']?></td>
    </tr>
	  <?php 
}
}?>
