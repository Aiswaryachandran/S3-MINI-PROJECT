  ...
  <tbody>
    <tr bgcolor="#FB9E9E">
      ...
      <td align="center" valign="middle">Type</td>
		<td align="center" valign="middle"><h5><?php echo $row1['typeofpack'] ?></h5></td>
    </tr>
    <tr>
      <td align="center" valign="middle">Details</td>
      <td align="center" valign="middle"><?php echo $row1['details'] ?></td>
    </tr>
    <tr bgcolor="#FB9E9E">
      <td align="center" valign="middle">Duration</td>
      <td align="center" valign="middle"><?php echo $row1['duration'] ?></td>
    </tr>
	  
    <tr>
      <td align="center" valign="middle">Time</td>
      <td align="center" valign="middle"><?php echo $row1['time slot'] ?></td>
    </tr>
    <tr bgcolor="#FB9E9E">
      <td align="center" valign="middle">Amount</td>
      <td align="center" valign="middle"><?php echo $row1['amount'] ?></td>
    </tr>
  </tbody>
</table><center>
						<br><?php
				  ...
				  ?>
						<p> <div class="btn"><a href="userboock.php?id=<?php echo $row1['pid']?>">Boock Now</a></div></p>
