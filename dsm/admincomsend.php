...
<table width="100%" border="0" cellpadding="0">
  ...
  <tbody>
    <tr>
	  ...
	  {
		  $result=mysqli_query($link,"select * from reg where usertype='user'");
...
if(isset($_SESSION['m1']))
            {
			 ...
			 <center> <h1>Compose Message</h1></center>
				<form action="admincomsend1.php" method="post" name="reg">
  ...
  <?php
    ...
    <tr>
      <td colspan="2"><div class="text">
	                   <textarea id="t13" name="t3" placeholder="Message"></textarea>
	                </div></td>
      <td><div class="to"> </div></td>
    </tr>
    <tr>
      <td><div class="contatct-top332"><input type="button" value="submit" id="s2" onClick="validation()"></div></td>
      <td>
			  </td>
    </tr>
			  </form>
