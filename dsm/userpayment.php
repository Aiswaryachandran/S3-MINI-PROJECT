      ...
      <td height="600" align="left" valign="top"><table width="100%">
        ...
        <table width="100%" border="0" cellpadding="0">
		  ...
		  $row1=mysqli_fetch_array($result1);
						  ...
						  {
							   header("Location:userquicknof.php?id=$id");
						  }
				  ?>
				  
				<table frame="box" width="100%"  border="1">
				  <tbody>
					  ...
					  <tr bgcolor="#D3D3D3">
				      <td colspan="4" align="center"><strong><em>PAYMENT RECEIPT</em></strong></td>
				      </tr>
				    <tr>
				      <td colspan="2">Date :&nbsp;<?php echo date("d-m-y") ?> </td>
				      <td colspan="2">Receipt No:&nbsp; <?php echo $row1['payid'] ?></td>
				      </tr>
				    <tr bgcolor="#D3D3D3">
				      <td colspan="2" align="left" valign="top"><p>From :
						  </p>
				        <p>DSM Admin</p>
				        <p> Iris Watson
				          P.O.</p>
				   ...
				   $result5=mysqli_query($link,"select * from lcreg where id=$id");
		  $row5=mysqli_fetch_array($result5);
				 		?>
				      <td colspan="2" align="left" valign="top">Bill To :&nbsp;<?php echo  $add; ?>.
				    ...
				    <tr align="center">
				      <td width="37%">Package Name</td>
				      <td width="13%">Intallment</td>
				      <td width="30%">Purpose</td>
				      <td width="20%">Amount</td>
				      </tr>
				    <tr align="center" bgcolor="#D3D3D3">
				      <td align="center"><?php echo $row1['package'] ?></td>
				      <td bgcolor="#D3D3D3"><?php echo $row1['installment']?></td>
				      <td><?php echo $row1['purpose']?></td>
				      <td><?php echo $row1['amountofpay']?></td>
				      </tr>
				    <tr>
				      <td>&nbsp;</td>
				      <td>&nbsp;</td>
				 ...
				 <p>This is a computer generated bill, show this to Dsm office for further procedures....</p>
				 <p>&nbsp;</p>
