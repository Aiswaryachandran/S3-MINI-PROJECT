...
$result=mysqli_query($link,"select id from triasin order by id DESC ");
...
$a3=$_POST["t1"];
$a5=$_SESSION['pn'];
//echo "insert into triasin value($id,$a1,$a2,$a3,'$a4','$a5',0)";
mysqli_query($link,"insert into triasin value($id,$a1,$a2,$a3,'$a4','$a5',0)");
$u=$_SESSION['u'];
mysqli_query($link,"UPDATE payinfo  SET tstatus=1 WHERE  payid=$u ");
