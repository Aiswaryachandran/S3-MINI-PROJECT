...
<table width="100%" border="0" cellpadding="0">
  ...
  <tbody>
	  ...
	  {
		  $result=mysqli_query($link,"select * from reg");
		  
	  ?>  
    <tr>
      <td>
		 <center>
			 <h1>Authorisation</h1>  </center>
	 
			 
<?php
if(isset($_SESSION['m1']) && isset($_SESSION['m2']))
            {
  ...
  <tbody>
    <tr align="center" valign="middle" bgcolor="#E91D20" class="blog-poast-info">
      <td>ID</td>
      <td>NAME</td>
    </tr>
	  <?php
    ...
    <tr  align="center" valign="top" bgcolor="#FB9E9E">
      <td>
        <?php  
				  echo $row['id']?>
      </td>
		<td><a href="adminauth2.php?id=<?php echo $row['id']?>"><?php echo $row['name']?></a>
		  </td>
    </tr>
	  <?php
			  }
