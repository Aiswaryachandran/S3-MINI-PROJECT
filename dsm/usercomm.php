				   ...
				   if(a3=="")
					 ...
					 <?php
					  ...
					  <center><h1> Compose Message</h1></center>
						...
						<br>
				<form action="usercomm1.php" method="post" name="reg">
				<table  align="center" width="80%" border="0">
				  <tbody>
				    <tr>
						
				      <td><select class="dp" name="t1" id="t1">
<option value="" selected disabled>Select</option>
  <option value="admin">Admin</option>
						...
						<td><div class="to"><input type="text" name="t2" id="t2" placeholder="Title"> </div>
						</td>
					  </tr>
				      <tr>
				      <td></td>
