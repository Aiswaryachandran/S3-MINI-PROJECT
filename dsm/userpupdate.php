...
if(isset($_SESSION['id']))
 ...
 $result1 = mysqli_query($link,"SELECT * FROM dpr where userid=$id");
              ...
              <td width="80%" rowspan="7" align="left" valign="top"><!-- InstanceBeginEditable name="EditRegion1" -->
                <table width="100%" border="0" cellpadding="0">
                  <tbody>
                    <tr>
                      <td>&nbsp; 
					    <center><h1> Driving Practice Reply </h1></center>
  ...
  <tbody>
    <tr align="center" valign="middle" bgcolor="#E91D20">
	 ...
	 <?php
		 ...
		 ?>
    <tr align="center" valign="middle" bgcolor=#ED9595>
		<td><?php echo $row1['dateofreq']?></td>
      
      <td><?php echo $row1['discription']?></td>
      <td><?php echo $row1['adminupdate']?></td>
