...
$date=date("d-m-y");
		 // echo "update comm set adminupdate='$m1' updatedate='$date' where  cid=$id";
		  mysqli_query($link,"UPDATE comm SET status=1 WHERE cid=$id234");
mysqli_query($link,"UPDATE comm SET adminupdate='$m1',updatedate='$date' WHERE cid=$id234");
?>
