...
<table width="100%" border="0" cellpadding="0">
  ...
  <tbody>
    <tr>
	  ...
	  {
		  $result=mysqli_query($link,"select * from reg where usertype='trainer'");
...
if(isset($_SESSION['m1']))
            {
                ...
                unset($_SESSION['m1']);
						...
						<br>
				<form action="admintrinersent1.php" method="post" name="reg">
					<div class="admin">
...
<option value="" selected disabled>Select</option>
  <?php
    ...
    <tr>
      <td><input type="button" value="submit" id="s2" onClick="validation()"></td>
      <td>
			  </td>
    </tr>
			  </form>
