...
<table width="100%" border="0" cellpadding="0">
                  ...
                  <tbody>
                    <tr>
                      <td>&nbsp;  <?php
						...
						$result=mysqli_query($link,"select * from payinfo where userid=$id");
			$row=mysqli_fetch_array($result);	  
						$pid=$row['pid'];
  ...
  <tbody>
	   <tr align="center" bgcolor="#F50C0C">
	     <td colspan="2" valign="top" bgcolor="#F50C0C" ><font size="+2" color="#FFFFFF">Your Package</font></td>
	     </tr>
    <tr align="left" bgcolor="#FDF9F7">
      <td valign="top">Type</td>
      <td valign="top"><?php echo $row1['typeofpack']?></td>
    </tr>
	  <tr align="left" bgcolor="#FB9E9E">
      <td valign="top">Details</td>
      <td valign="top"><?php echo $row1['duration']?></td>
    </tr>
    <tr align="left" bgcolor="#FDF9F7">
      <td valign="top">Time</td>
      <td valign="top"><?php echo $row1['time slot']?></td>
    </tr>
    <tr align="left" bgcolor="#FB9E9E">
      <td valign="top">Amount</td>
      <td valign="top"><?php echo $row1['amount']?></td>
    </tr>
    <tr align="left" bgcolor="#FDF9F7">
      <td valign="top">Pack Name</td>
      <td valign="top"><?php echo $row1['pack name']?></td>
    </tr>
   <br>
