    ...
    <tr>
      <td height="600" align="left" valign="top"><table width="100%">
        ...
        <table width="100%" border="0" cellpadding="0">
          <tbody>
            <tr bgcolor="#FFD05B">
              <td height="34" align="center" valign="middle">Home</td>
              <td align="center" valign="middle">Package Info</td>
              <td align="center" valign="middle">About As</td>
              <td align="center" valign="middle">Feedback</td>
              <td align="center" valign="middle">Contact Us</td>
              <td align="center" valign="middle">Register</td>
              <td align="center" valign="middle">Login</td>
            </tr>
          </tbody>
        </table>
        <table width="100%" border="0" cellpadding="0">
          <tbody>
            <tr>
              <td height="457" align="left" valign="top"><!-- TemplateBeginEditable name="EditRegion1" -->
