				   ...
				   if(a3=="")
						{
						  ...
						  <center><h1>Request Driving Practice</h1></center>
				
				<form name="reg" method="post" action="usertrainprac1.php">
				<table align="center" width="75%" border="0">
  <tbody>
    <tr>
      <td></td>
      <td><div class="to1230"><input type="text" name="t1" id="t1" placeholder="REQUEST"> </div></td>
      <td></td>
      <td><div class="to1230"><input type="text" name="t2" id="t2" placeholder="EXPECTED TIME"> </div></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td></td>
      <td><div>
	                   <textarea  class="smalldrop" id="t3" name="t3" placeholder="DESCRIPTION"></textarea>
	                </div></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td align="center"><div class="smallbutton">
  <p>
