	...
	if(mysqli_num_rows($result1)>0)
		  {
			   ...
			   $_SESSION['id'];
				  header("Location:userpackageview.php?id=$id");
		  }
...
<table width="100%" border="0" cellpadding="0">
              ...
              <td width="80%" rowspan="7" align="left" valign="top"><!-- InstanceBeginEditable name="EditRegion1" -->
                <table width="100%" border="0" cellpadding="0">
                  <tbody>
                    <tr>
                      <td>&nbsp;
						  <center><h1>No Package Found</h1></center>
  ...
  <tbody>
	  <tr>
	  <td>
		   <a href="userpackage.php">Book Your Package Now....</a>
		  </td>
	  </tr>
	 
    <tr>
      <td><a href="userHome.php"><div class="smallbutton"><input  type="button" value="BACK"></div></a></td>
	  </tr>
			  </tbody>
				  </table>
						   </td>
