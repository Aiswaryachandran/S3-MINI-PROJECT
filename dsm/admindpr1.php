...
{
$result = mysqli_query($link,"select *  from dpr where dprid=$id");
$row = mysqli_fetch_array($result);
	session_start();
	$_SESSION['m1']=$id;

?>
		<form method="post" action="admindpr2.php" name="p">
 ...
 <tr align="center" valign="middle" bgcolor="#FB9E9E">
 <td colspan="2">
	                   <textarea class="dp" id="t1" name="t1" placeholder="Rplay"></textarea>
	             </td>
 
 </tr>
	  <tr align="center" valign="middle" bgcolor="#FFFFFF">
 <td colspan="2"> <div class="contatct-top332">
  
    <input type="button" value="submit" id="s1" onClick="v()"></td>
		  <td></td></form>
 </tr>
	  <?php } ?>
  </tbody>
