...
$result2=mysqli_query($link,"select * from reg where id=$a1 ");
...
$u2="admin";
		  ...
		  //echo "insert into comm values($cid,$u1,'$u2','$u3','$n','$a2','$a3','$date',0,'$a1')";
		  
mysqli_query($link,"insert into comm values($cid,$u1,'$u2',NULL,'$n','$a2','$a3','$date',0,'$a1',NULL,NULL)");
		//  $_SESSION['m1']='sussefully sent';
		 // header("Location:http://localhost/windsoft/admincomsend.php");
?>
<center>  <h1>Successfully Send </h1><center>
